...
mod tests {
    ...
    #[test]
    fn alloc_vec_bag_impl_contract() {
        let mut bag = <alloc::vec::Vec<u32> as Bag>::build();
        assert!(bag.is_empty());
    ...
    #[test]
    fn hashbrown_hashset_bag_rejects_duplicates() {
    ...
    #[test]
    fn hashbrown_hashmap_bag_rejects_duplicate_keys() {
