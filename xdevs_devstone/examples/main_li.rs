...
fn main() {
    const WIDTH: usize = 200; //a lo mejor me toca sacar WIDTH y DEPTH del main y hacerlas globales para que los tests puedan usarlas
...
mod test {
    ...
    #[test]
    fn test_li() {
        const WIDTH: usize = 100; //a lo mejor me toca sacar WIDTH y DEPTH del main y hacerlas globales para que los tests puedan usarlas
        ...
        xdevs_devstone_macros::generate_li!(100, 100);
        //Creación del modelo atómico generador (mete datos en el modelo LI)
        let generator = Generator::new(5);
        // //Creación del modelo final (modelo LI + atómico generador que mete datos en el puerto del LI)
