...
const OUTPUT_RELATIVE_PATH: &str = "examples/main_generated.rs";
...
fn main() {{
	...
	xdevs_devstone_macros::{macro_name}!({width}, {depth});

	let generator = Generator::new(5);

	let modelo_final: ModeloFinal<W> = ModeloFinal::build(generator, {model_var});
